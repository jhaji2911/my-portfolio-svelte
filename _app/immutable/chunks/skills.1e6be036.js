import{A as s}from"./UIcon.9f96962e.js";const p=`# Svelte
...
> Vue.js is a free and open-source front end JavaScript framework created by Evan You and maintained by him along with the Vue core team.`,m=`---
...
> Node.js is a free and open-source, cross-platform JavaScript runtime environment created by Ryan Dahl and maintained by the Node.js Foundation.`,h=`---
...
> Rust is a free and open-source systems programming language designed by Graydon Hoare and developed by Mozilla Research.`,b=`# JavaScript (JS)
...
> JavaScript is a high-level, interpreted programming language that conforms to the ECMAScript specification.`,y=`---
...
> TypeScript is a free and open-source programming language developed and maintained by Microsoft.`,f=`---
...
> CSS is a style sheet language used for describing the presentation of a document written in HTML or XML.`,v=`---
...
> Sass is a preprocessor scripting language that is interpreted or compiled into CSS.`,S=`---
...
> HTML is the standard markup language for documents designed to be displayed in a web browser.`;function w(e,...t){const o=Object.assign({},e);return Object.keys(o).forEach(a=>{t.includes(a)&&delete o[a]}),o}const n=e=>e,k=[n({name:"Programming Languages",slug:"pro-lang"}),n({name:"Frameworks",slug:"framework"}),n({name:"Libraries",slug:"library"}),n({name:"Languages",slug:"lang"}),n({name:"Databases",slug:"db"}),n({name:"ORMs",slug:"orm"}),n({name:"DevOps",slug:"devops"}),n({name:"Testing",slug:"test"}),n({name:"Dev Tools",slug:"devtools"}),n({name:"Markup & Style",slug:"markup-style"}),n({name:"Design",slug:"design"}),n({name:"Soft Skills",slug:"soft"})],i=e=>{const t=w(e,"category");return e.category&&(t.category=k.find(o=>o.slug===e.category)),t},c=[i({slug:"js",color:"yellow",description:b,logo:s.JavaScript,name:"Javascript",category:"pro-lang"}),i({slug:"ts",color:"blue",description:y,logo:s.TypeScript,name:"Typescript",category:"pro-lang"}),i({slug:"css",color:"blue",description:f,logo:s.CSS,name:"CSS",category:"markup-style"}),i({slug:"html",color:"orange",description:S,logo:s.HTML,name:"HTML",category:"markup-style"}),i({slug:"sass",color:"pink",description:v,logo:s.Sass,name:"Sass",category:"markup-style"}),i({slug:"nodejs",color:"green",description:m,logo:s.NodeJs,name:"Node JS",category:"library"}),i({slug:"reactjs",color:"cyan",description:u,logo:s.ReactJs,name:"React Js",category:"library"}),i({slug:"vue",color:"green",description:g,logo:s.VueJs,name:"VueJs",category:"library"}),i({slug:"svelte",color:"orange",description:p,logo:s.Svelte,name:"Svelte",category:"library"}),i({slug:"rust",color:"orange",description:h,logo:s.Rust,name:"Rust",category:"lang"})],T="Skills",M=(...e)=>c.filter(t=>e.includes(t.slug)),J=e=>{const t=[],o=[];return c.forEach(a=>{if(e.trim()&&!a.name.toLowerCase().includes(e.trim().toLowerCase()))return;if(!a.category){console.log(a.category),o.push(a);return}let r=t.find(d=>{var l;return d.category.slug===((l=a.category)==null?void 0:l.slug)});r||(r={items:[],category:a.category},t.push(r)),r.items.push(a)}),o.length!==0&&t.push({category:{name:"Others",slug:"others"},items:o}),t};export{J as a,M as g,c as i,T as t};
